...
function generate(params, callback) {
  return new Promise(function(resolve, reject) {
    params = defaults(params || {}, {
      ...
      navigateFallbackRegexesIncludeParameters: false,
      replacePrefix: '',
      skipWaiting: true,
      staticFileGlobs: [],
      stripPrefix: '',
    ...
    fs.readFile(params.templateFilePath, 'utf8', function(error, data) {
      ...
      var populatedTemplate = template(data)({
        ...
        navigateFallbackBlacklist:
          JSON.stringify(params.navigateFallbackBlacklist.map(function(regex) {
            return regex.source;
          })),
        navigateFallbackRegexesIncludeParameters:
          params.navigateFallbackRegexesIncludeParameters,
